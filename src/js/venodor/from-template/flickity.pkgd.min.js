...
!(function(t, e) {
    ...
    return (
      ...
      (p.queryCell = function(t) {
        return 'number' == typeof t
          ? this.cells[t]
          : ('string' == typeof t && (t = this.element.querySelector(t)), this.getCell(t))
      }),
      (p.uiChange = function() {
  ...
  (function(t, e) {
    'function' == typeof define && define.amd
      ? define('flickity/js/add-remove-cell', ['./flickity', 'fizzy-ui-utils/utils'], function(
          i,
          n,
        ) {
          return e(t, i, n)
    ...
    return (
      ...
      (n.navCompanionSelect = function(t) {
        if (this.navCompanion) {
          ...
          if (
            (this.selectCell(o, !1, t), this.removeNavSelectedElements(), !(o >= this.cells.length))
          ) {
